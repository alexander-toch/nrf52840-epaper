// from https://github.com/ZinggJM/GxEPD
...
// #define GxEPD2_DRIVER_CLASS GxEPD2_213_B74 // GDEM0213B74 122x250, SSD1680, FPC-7528B) // # FIXME: this is the one I have
...
#define GxEPD2_DRIVER_CLASS GxEPD2_750_T7 // GDEW075T7   800x480, EK79655 (GD7965), (WFT0583CZ61) // FIXME: this is the big one I have
...
// adapt the constructor parameters to your wiring
// GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS=D8*/ EPD_CS, /*DC=D3*/ 0, /*RST=D4*/ 2, /*BUSY=D2*/ 4));
// mapping of Waveshare e-Paper Universal HAT
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS=D7*/ D7, /*DC=D5*/ D5, /*RST=D4*/ D4, /*BUSY=D3*/ D3));
